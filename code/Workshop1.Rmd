...
#the part pf the code 'mapping =' is not necessary
```
...
# 'alpha' is the code to made the data change reansparemcy
# consider trying a simple number, like 0.3 to this aesthetic, which globally applies a transparency to all points
```{r}
ggplot(data = mpg) + 
